      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              <a 
                href="https://instagram.com/otterseas" 
                target="_blank" 
              ...
              <a 
                href="https://www.etsy.com/uk/shop/Otterseas" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-white/40 hover:text-white transition-colors"
                aria-label="Etsy"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M8.56 4.22c0-.52.08-.67.67-.67h4.9c1.83 0 2.42.52 3.1 2.58l.52 1.56h1.01l-.36-4.68c-.36.15-.78.23-1.29.23H5.46c-.51 0-.93-.08-1.29-.23v.75c1.17.15 1.4.44 1.4 2.04v11.86c0 1.6-.23 1.88-1.4 2.04v.75c.36-.15.77-.23 1.29-.23h10.57c.51 0 .93.08 1.29.23l.72-4.66h-1.01l-.44 1.37c-.52 1.63-1.25 2.27-3.07 2.27H8.56c-.6 0-.67-.16-.67-.67v-7.05h4.06c1.17 0 1.56.6 1.87 2.11h1.01V9.11h-1.01c-.31 1.52-.7 2.11-1.87 2.11H7.89V4.22z"/>
                </svg>
              </a>
            </div>
          </div>
